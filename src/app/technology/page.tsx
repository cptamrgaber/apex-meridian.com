          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-lg p-6 text-center">
                ...
                <h4 className="text-lg font-bold text-gray-900 mb-2">AI Models</h4>
              ...
              <div className="bg-gray-50 rounded-lg p-6 text-center">
                ...
                <h4 className="text-lg font-bold text-gray-900 mb-2">Data Storage</h4>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-gray-900">Ethical AI Framework</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-gray-900">Human-AI Collaboration</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-gray-900">Adaptive Learning</h4>
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h4 className="text-lg font-bold text-gray-900 mb-4">Current Projects</h4>
