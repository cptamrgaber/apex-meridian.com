        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-200 max-w-3xl mx-auto">
              Join us in revolutionizing artificial intelligence across multiple industries. Discover why Apex-Meridian represents a compelling investment opportunity in the rapidly growing AI market.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              What sets Apex-Meridian apart in the competitive AI landscape
            </p>
          </div>
