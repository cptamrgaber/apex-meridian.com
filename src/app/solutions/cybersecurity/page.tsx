    ...
    <div className="bg-gray-900 min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-red-900 via-red-800 to-orange-900 text-white py-24 sm:py-32 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <Image
            src="/images/solutions/cybersecurity-ai-hq.jpg"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="bg-gray-900/80 backdrop-blur-md rounded-3xl p-8">
              <div className="flex items-center space-x-4 mb-6">
                <div className="w-20 h-20 bg-red-600/30 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                  <Shield className="h-10 w-10 text-white" />
                </div>
                <div>
                  <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight text-white">CyberGuard</h1>
              ...
              <div className="bg-gray-900/80 backdrop-blur-md rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-white">Real-time Threat Detection</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-6 h-6 text-green-400" />
                    <span className="text-white">Automated Incident Response</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-6 h-6 text-green-400" />
                    <span className="text-white">Predictive Risk Analysis</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-6 h-6 text-green-400" />
                    <span className="text-white">Zero-Day Vulnerability Protection</span>
                  </div>
                </div>
              </div>
            </div>
