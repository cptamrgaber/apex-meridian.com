...
export default function CybersecuritySolutionsPage() {
  return (
    <div className="bg-white min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-red-900 to-orange-900 text-white py-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-red-50 rounded-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600">
                How GlobalTech Corp prevented a major cyber attack with Apex-Meridian AI
              </p>
            </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-lg">
                ...
                <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                  <p className="text-sm text-gray-600 italic">
                    &quot;Apex-Meridian&apos;s AI saved us from what could have been a catastrophic breach. Their technology is years ahead of anything else we&apos;ve seen.&quot;
                  </p>
