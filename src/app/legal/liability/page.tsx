        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">AI Performance Disclaimers</h3>
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Technical Limitations</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Maximum Liability Cap</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
