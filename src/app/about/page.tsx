          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Link href="/about/overview" className="group">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border-2 border-transparent group-hover:border-blue-500">
                <div className="bg-blue-900 dark:bg-blue-900 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:bg-blue-200 dark:group-hover:bg-blue-800 transition-colors">
                  <Building className="h-8 w-8 text-blue-300 dark:text-blue-400" />
                </div>
                ...
                <div className="flex items-center justify-center text-blue-300 dark:text-blue-400 group-hover:text-blue-100 dark:group-hover:text-blue-300">
            ...
            <Link href="/about/leadership" className="group">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border-2 border-transparent group-hover:border-blue-500">
                <div className="bg-green-900 dark:bg-green-900 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:bg-green-200 dark:group-hover:bg-green-800 transition-colors">
            ...
            <Link href="/about/history" className="group">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border-2 border-transparent group-hover:border-blue-500">
                <div className="bg-purple-900 dark:bg-purple-900 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:bg-purple-200 dark:group-hover:bg-purple-800 transition-colors">
                  <History className="h-8 w-8 text-purple-300 dark:text-purple-400" />
                </div>
            ...
            <Link href="/about/careers" className="group">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border-2 border-transparent group-hover:border-blue-500">
                <div className="bg-orange-900 dark:bg-orange-900 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:bg-orange-200 dark:group-hover:bg-orange-800 transition-colors">
                  <Briefcase className="h-8 w-8 text-orange-300 dark:text-orange-400" />
                </div>
      ...
      <section className="py-16 bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="text-4xl font-bold text-blue-300 dark:text-blue-400 mb-2">Growing</div>
              <p className="text-gray-600 dark:text-gray-300 font-medium">{t('about.stats.users')}</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-blue-300 dark:text-blue-400 mb-2">Trusted</div>
              <p className="text-gray-600 dark:text-gray-300 font-medium">{t('about.stats.clients')}</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-blue-300 dark:text-blue-400 mb-2">Reliable</div>
