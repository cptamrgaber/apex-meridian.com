      ...
      <section className="py-16 bg-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-200 mb-8 max-w-2xl mx-auto">
            We&apos;re building a world-class team of leaders who share our vision for the future of AI. Explore leadership opportunities at <span className="font-semibold tracking-wider" style={{ letterSpacing: '0.15em' }}>
              <span>A p e x</span>
