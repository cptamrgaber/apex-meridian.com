      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-lg shadow p-6 mt-6">
              ...
              <div className="space-y-3">
                <button className="w-full text-left px-4 py-2 rounded-md hover:bg-gray-50 flex items-center">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-gray-900">Submitted expense report for Q4 2024</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-gray-900">Approved leave request for Dec 25-26</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-gray-900">Completed mandatory security training</p>
            ...
            <div className="bg-white rounded-lg shadow">
              <div className="px-6 py-4 border-b border-gray-200">
                <h3 className="text-lg font-medium text-gray-900">Company Resources</h3>
              </div>
              <div className="p-6">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <a href="#" className="block p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <h4 className="font-medium text-gray-900">Benefits Portal</h4>
